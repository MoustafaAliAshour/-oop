...
public class ListOfRegistrations extends javax.swing.JFrame {

       private String FILE_NAME;

    public ListOfRegistrations() {
        initComponents();
    ...
    private void loadDataToTable() {
        ...
        FILE_NAME = FileNames.REGISTRATION_FILENAME;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List of Registrations");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Member Id", "Class Id", "Registation Date"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListOfRegistrations.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListOfRegistrations().setVisible(true);
            }
        });
    }
